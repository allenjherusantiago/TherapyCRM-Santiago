...
class AddRecordForm(forms.ModelForm):
    ...
    notes = forms.CharField(
        ...
        widget=forms.Textarea(attrs={
            "placeholder": "Enter notes or diagnosis here...",
            "class": "form-control",
            "rows": 5,
            "style": "resize: vertical;"  # For resizing the textarea vertically
        }),
        label=""
    )
    ...
    class Meta:
        ...
        widgets = {
            'notes': forms.Textarea(attrs={
                "placeholder": "Notes or Diagnosis",
                "class": "form-control",
                "rows": 5,
        ...
        error_messages = {
            'notes': {
                'max_length': 'This Text Box Can Only Have a Maximum of 5000 Characters...',
            }
        }

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Add max_length to the 'notes' field
        self.fields['notes'].max_length = 5000
